...
![1-5 пункты задания лабораторной](image/image1.PNG){ #fig:001 width=70% height=70% }
...
![6 пункт задания лабораторной](image/image2.PNG){ #fig:002 width=70% height=70% }

7. Попробуйте удалить файл file1 либо стереть имеющуюся в нём информацию командой echo "abcd" > /home/guest/dirl/file1
Попробуйте переименовать файл.

![7 пункт задания лабораторной](image/image3.PNG){ #fig:003 width=70% height=70% }
...
![9 пункт задания лабораторной](image/image4.PNG){ #fig:004 width=70% height=70% }
...
![10 пункт задания лабораторной](image/image5.PNG){ #fig:005 width=70% height=70% }
